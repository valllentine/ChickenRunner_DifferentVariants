...
{
    public enum gameStates { LeftRoad, RightRoad, Jump, Calm};
    public gameStates gameState = gameStates.Calm;
    public int score;
    ...
    void Update()
    {
            switch (gameState)
            {
                case gameStates.LeftRoad:
                    MoveHorizontal(-laneChangeSpeed);
                    gameState = gameStates.Calm;
                    break;

                case gameStates.RightRoad:
                    MoveHorizontal(laneChangeSpeed);
                    gameState = gameStates.Calm;
                    break;
                ...
                case gameStates.Calm:
                    ...
                    {
                        gameState = gameStates.RightRoad;
                    }
                    if (Input.GetKeyDown(KeyCode.A) && pointFinish > -laneOffset)
                    {
                        gameState = gameStates.LeftRoad;
                    }
                    else if (Input.GetKeyDown(KeyCode.W) && isJumping == false)
                    {
                        gameState = gameStates.Jump;
                    }
                    break;
            }
